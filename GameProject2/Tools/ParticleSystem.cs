...
namespace GameProject2.Tools
{
    ...
    public static class RandomHelper
    {
        ...
        public static Vector2 NextHorizontalDirection()
        {
            if (Next(0, 2) == 0)
            {
                return new Vector2(MathF.Cos(MathHelper.Pi), MathF.Sin(MathHelper.Pi));
            }
            return new Vector2(MathF.Cos(MathHelper.TwoPi), MathF.Sin(MathHelper.TwoPi));
        }
