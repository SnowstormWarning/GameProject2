...
namespace Basic3D
{
    ...
    public class Cube
    {
        ...
        public Vector2 Position => new Vector2(-3,1);
        ...
        public Cube(Game1 game, short[] indexData)
        {
            this.game = game;
            InitializeVertices();
            InitializeIndices(indexData);
            InitializeEffect();
        }
        ...
        public void InitializeVertices()
        {
            ...
            new VertexPositionColor() { Position = new Vector3(-0.1f,  0.1f, -0.1f), Color = Color.Blue },
            new VertexPositionColor() { Position = new Vector3( 0.1f,  0.1f, -0.1f), Color = Color.Green },
            new VertexPositionColor() { Position = new Vector3(-0.1f, -0.1f, -0.1f), Color = Color.Red },
            new VertexPositionColor() { Position = new Vector3( 0.1f, -0.1f, -0.1f), Color = Color.Cyan },
            new VertexPositionColor() { Position = new Vector3(-0.1f,  0.1f,  0.1f), Color = Color.Blue },
            new VertexPositionColor() { Position = new Vector3( 0.1f,  0.1f,  0.1f), Color = Color.Red },
            new VertexPositionColor() { Position = new Vector3(-0.1f, -0.1f,  0.1f), Color = Color.Green },
            new VertexPositionColor() { Position = new Vector3( 0.1f, -0.1f,  0.1f), Color = Color.Cyan }
        ...
        /// </summary>
        public void InitializeIndices(short[] indexData)
        {
